...
var DataArrLewdle = lewdle.map(function (element) {
    var wordObj = { word: element.toLowerCase() };
    //calc frequency score
    var score = 0;
    for (var i = 0; i < element.length; i++) {
        var character = element.charAt(i);
...
function CalculateStats() {
    var ss = PersistUserChanges.GetStats();
    if (GAME == 1) {
    ...
    if (ss) {
        ...
        GAME == 1 ? PersistUserChanges.SaveStatsLewdle(SortedStats) : PersistUserChanges.SaveStats(SortedStats);
    }
    console.log("SortedStats: ", SortedStats);

    var fl = "";
    for (var i = 0; i < SortedStats.Overall.length; i++) {
        fl = fl + '<span class="lflist" title="' + SortedStats.Overall[i].Count + ' occurences">' + SortedStats.Overall[i].letter + '</span>';
    }
    $("#FreqLet").html(fl);

    fl = "Pos 1<br />";
    for (var i = 0; i < 6; i++) {
        fl = fl + '<span class="lflist" title="' + SortedStats.l0[i].Count + ' occurences">' + SortedStats.l0[i].letter + "</span><br />";
    }
    $("#pos1").html(fl);

    fl = "Pos 2<br />";
    for (var i = 0; i < 6; i++) {
        fl = fl + '<span class="lflist" title="' + SortedStats.l1[i].Count + ' occurences">' + SortedStats.l1[i].letter + "</span><br />";
    }
    $("#pos2").html(fl);

    fl = "Pos 3<br />";
    for (var i = 0; i < 6; i++) {
        fl = fl + '<span class="lflist" title="' + SortedStats.l2[i].Count + ' occurences">' + SortedStats.l2[i].letter + "</span><br />";
    }
    $("#pos3").html(fl);

    fl = "Pos 4<br />";
    for (var i = 0; i < 6; i++) {
        fl = fl + '<span class="lflist" title="' + SortedStats.l3[i].Count + ' occurences">' + SortedStats.l3[i].letter + "</span><br />";
    }
    $("#pos4").html(fl);

    fl = "Pos 5<br />";
    for (var i = 0; i < 6; i++) {
        fl = fl + '<span class="lflist" title="' + SortedStats.l4[i].Count + ' occurences">' + SortedStats.l4[i].letter + "</span><br />";
    }
    $("#pos5").html(fl);
